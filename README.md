# Awesome Microsoft Security 🔐☁️

A curated list of high-quality resources focused on securing Microsoft cloud environments, including Identity (Entra ID), Microsoft 365, Microsoft Defender, and Microsoft Purview.

> Covering Zero Trust, identity protection, threat detection, data security, and compliance across the Microsoft ecosystem.
...
- [Identity security best practices](https://learn.microsoft.com/security/identity-protection/)
...
**⭐ Editor’s Picks**
- [Zero Trust identity guidance](https://learn.microsoft.com/security/zero-trust/identity)
- [Securing privileged access](https://learn.microsoft.com/security/privileged-access-workstations/)
...
- [Microsoft Defender XDR overview](https://learn.microsoft.com/microsoft-365/security/defender/microsoft-365-defender)
...
**⭐ Editor’s Picks**
- [Attack simulation training](https://learn.microsoft.com/microsoft-365/security/office-365-security/attack-simulation-training)
- [Advanced hunting queries](https://learn.microsoft.com/microsoft-365/security/defender/advanced-hunting-overview)
...
- [Secure Score](https://learn.microsoft.com/microsoft-365/security/defender/microsoft-secure-score)
- [Email & collaboration security](https://learn.microsoft.com/microsoft-365/security/office-365-security/)
- [Exchange Online Protection](https://learn.microsoft.com/exchange/mail-flow-best-practices/)

**⭐ Editor’s Picks**
- [Microsoft 365 security baseline](https://learn.microsoft.com/security/benchmark/azure/security-baselines-overview)
- [Best practices for securing Microsoft 365](https://learn.microsoft.com/microsoft-365/security/)
...
**⭐ Editor’s Picks**
- [DLP deep dive](https://learn.microsoft.com/purview/dlp-learn-about-dlp)
...
- [Zero Trust architecture](https://learn.microsoft.com/security/zero-trust/architecture)
- [Least privilege model](https://learn.microsoft.com/security/zero-trust/deploy/privileged-access)
- [Defense in depth strategy](https://learn.microsoft.com/security/)
...
- [Maester](https://maester.dev/): Microsoft Security test automation framework
- [Microsoft Cloud command line](https://cmd.ms/)
- [Microsoft Portals](https://msportals.io/)
- [Microsoft 365 Message Center Archive](https://mc.merill.net/): This site is an archive of Microsoft 365 Message Center messages for quick reference.
- [Conditional Access Documenter](https://idpowertoys.merill.net/ca): Export your conditional access policies as a PowerPoint presentation.
...
- [SC-900: Microsoft Security, Compliance, and Identity Fundamentals - Microsoft Learn Youtube](https://www.youtube.com/watch?v=3D6s2UxNI28&list=PLahhVEj9XNTc3cKjd28NUDFPrV4QcfxH5)
### SC-100
...
-   [Preparing for SC-100: Design solutions that align with security best practices and priorities (Part 1 of 4)](https://learn.microsoft.com/en-us/shows/exam-readiness-zone/preparing-for-sc-100-design-solutions-that-align-with-security-best-practices-and-priorities)
-   [Preparing for SC-100: Design security operations, identity, and compliance capabilities (Part 2 of 4)](https://learn.microsoft.com/en-us/shows/exam-readiness-zone/preparing-for-sc-100-design-security-operations-identity-and-compliance-capabilities)
-   [Preparing for SC-100: Design security solutions for infrastructure (Part 3 of 4)](https://learn.microsoft.com/en-us/shows/exam-readiness-zone/preparing-for-sc-100-design-security-solutions-for-infrastructure)
-   [Preparing for SC-100: Design security solutions for applications and data (Part 4 of 4)](https://learn.microsoft.com/en-us/shows/exam-readiness-zone/preparing-for-sc-100-design-security-solutions-for-applications-and-data)
...
-  [Preparing for the SC-100 Exam - Microsoft Learn - YouTube](https://www.youtube.com/watch?v=6-05jW9lMiM&list=PLahhVEj9XNTc0n9Kr47L8N7U1cTr3uWax)
### SC-200
- [SC-200: Security Operations Analyst](https://learn.microsoft.com/certifications/sc-200/)
- [Preparing for the SC-200 Exam - Microsoft Learn - YouTube](https://www.youtube.com/watch?v=M5RvEabcgZk&list=PLahhVEj9XNTcHNtYH-inn7xFJactEM7zz)
- [SC-200: Microsoft Security Operations Analyst - Microsoft Learn - YouTube](https://www.youtube.com/watch?v=thcE2t1TH50&list=PLahhVEj9XNTfSpvU-_iEvLJXiA0EDXkXQ)
### SC-300
- [SC-300: Identity and Access Administrator](https://learn.microsoft.com/certifications/sc-300/)
- [Preparing for the SC-300 Exam - Microsoft Learn YouTube](https://www.youtube.com/watch?v=oZ0RkKVrtaM&list=PLahhVEj9XNTfkF9FZHW7FDcdcYRk9kO0d)
### SC-401
> [!IMPORTANT]  
...
- [Tech Community - Microsoft Security](https://techcommunity.microsoft.com/)
- [Azure AD / Entra blog](https://techcommunity.microsoft.com/t5/microsoft-entra-azure-ad-blog/bg-p/Identity)
...
- Add useful resources (docs, blogs, tools, labs)
- Keep descriptions concise
- Prefer official or high-quality community content

---

## ⭐ Support

If you find this repository useful, consider giving it a star ⭐ and sharing it with others in the community.
